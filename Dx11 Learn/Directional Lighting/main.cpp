...
///////////////**************new**************////////////////////
XMMATRIX LightRotation;
///////////////**************new**************////////////////////
float rot = 0.01f;
float lightrot = 0.00001f;
...
void UpdateScene(double time)
{
	...
	///////////////**************new**************////////////////////
	lightrot += 0.001f;
	if (lightrot > 0.00628f)
		lightrot = 0.0f;
	LightRotation = XMMatrixRotationAxis(rotaxis, lightrot);
	XMStoreFloat3(&light.dir, XMVector3Transform(XMLoadFloat3(&light.dir), LightRotation));
	///////////////**************new**************////////////////////
